...
if (isset($_POST['reason'])) {
    $reason = $_POST['reason'];
    $sql9 = "INSERT INTO sales_replace (Sales_Replace_Reason,Sales_Order_idSales_Order ) VALUES ('$reason','$sid')";
    ...
    if ($res9) {
        ...
        while ($row12 = mysqli_fetch_assoc($result12)) {
            ...
            // echo $qty;
            echo $ids;
            $sql13 = "INSERT INTO `sales_replace _detail` (`qty_replace`, `Sales_Replace_idSales_Replace`, `Product_Master_idProduct_Master`) VALUES ('$qty', '$ids', '$pid')";
