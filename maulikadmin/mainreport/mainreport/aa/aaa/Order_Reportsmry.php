...
?>
	...
	';?>
                                        ...
                                        <td data-field="idsales_orders">
                                            <div class="Order_Report_idsales_orders"><span
                                        ...
                                        <td data-field="idsales_orders">
                                            ...
                                            <div class="ew-table-header-btn Order_Report_idsales_orders">
                                                <span
                                                    class="ew-table-header-caption"><?php echo $Page->idsales_orders->caption() ?></span>
                                            </div>
                                            <?php } else { ?>
                                            <div class="ew-table-header-btn ew-pointer Order_Report_idsales_orders"
                                        ...
                                        <td data-field="bussiness_name">
                                            <div class="Order_Report_bussiness_name"><span
                                        ...
                                        <td data-field="bussiness_name">
                                            ...
                                            <?php } else { ?>
                                            <div class="ew-table-header-btn ew-pointer Order_Report_bussiness_name"
                                        ...
                                        <td data-field="address">
                                            <div class="Order_Report_address"><span
                                                    class="ew-table-header-caption"><?php echo $Page->address->caption() ?></span>
                                            </div>
                                        </td>
                                        <?php } else { ?>
                                        <td data-field="address">
                                            <?php if ($Page->sortUrl($Page->address) == "") { ?>
                                            <div class="ew-table-header-btn Order_Report_address">
                                                <span
                                                    class="ew-table-header-caption"><?php echo $Page->address->caption() ?></span>
                                            </div>
                                            <?php } else { ?>
                                            <div class="ew-table-header-btn ew-pointer Order_Report_address"
                                                onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->address) ?>',0);">
                                                <span
                                                    class="ew-table-header-caption"><?php echo $Page->address->caption() ?></span>
                                                <span
                                                    class="ew-table-header-sort"><?php if ($Page->address->getSort() == "ASC") { ?><i
                                                        class="fa fa-sort-up"></i><?php } elseif ($Page->address->getSort() == "DESC") { ?><i
                                                        class="fa fa-sort-down"></i><?php } ?></span>
                                            </div>
                                            <?php } ?>
                                        </td>
                                        ...
                                        <?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
                                        <td data-field="pname">
                                            <div class="Order_Report_pname"><span
                                        ...
                                        <td data-field="pname">
                                            ...
                                            <?php } else { ?>
                                            <div class="ew-table-header-btn ew-pointer Order_Report_pname"
                                        ...
                                        <?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
                                        <td data-field="brand">
                                            <div class="Order_Report_brand"><span
                                        ...
                                        <td data-field="brand">
                                            ...
                                            <?php } else { ?>
                                            <div class="ew-table-header-btn ew-pointer Order_Report_brand"
                                        ...
                                        <td data-field="description">
                                            <div class="Order_Report_description"><span
                                        ...
                                        <td data-field="description">
                                            ...
                                            <?php } else { ?>
                                            <div class="ew-table-header-btn ew-pointer Order_Report_description"
                                        ...
                                        <?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
                                        <td data-field="Qty">
                                            <div class="Order_Report_Qty"><span
                                                    class="ew-table-header-caption"><?php echo $Page->Qty->caption() ?></span>
                                            </div>
                                        </td>
                                        <?php } else { ?>
                                        <td data-field="Qty">
                                            ...
                                            <?php } else { ?>
                                            <div class="ew-table-header-btn ew-pointer Order_Report_Qty"
                                                onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->Qty) ?>',0);">
                                                <span
                                                    class="ew-table-header-caption"><?php echo $Page->Qty->caption() ?></span>
                                                <span
                                                    class="ew-table-header-sort"><?php if ($Page->Qty->getSort() == "ASC") { ?><i
                                                        class="fa fa-sort-up"></i><?php } elseif ($Page->Qty->getSort() == "DESC") { ?><i
                                                        class="fa fa-sort-down"></i><?php } ?></span>
                                            </div>
                                            <?php } ?>
                                        </td>
                                        ...
                                        <td data-field="discount">
                                            <div class="Order_Report_discount"><span
                                                    class="ew-table-header-caption"><?php echo $Page->discount->caption() ?></span>
                                            </div>
                                        </td>
                                        <?php } else { ?>
                                        <td data-field="discount">
                                            ...
                                            <?php } else { ?>
                                            <div class="ew-table-header-btn ew-pointer Order_Report_discount"
                                                onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->discount) ?>',0);">
                                                <span
                                                    class="ew-table-header-caption"><?php echo $Page->discount->caption() ?></span>
                                                <span
                                                    class="ew-table-header-sort"><?php if ($Page->discount->getSort() == "ASC") { ?><i
                                                        class="fa fa-sort-up"></i><?php } elseif ($Page->discount->getSort() == "DESC") { ?><i
                                                        class="fa fa-sort-down"></i><?php } ?></span>
                                            </div>
                                            <?php } ?>
                                        </td>
                                        ...
                                        <?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
                                        <td data-field="Price">
                                            <div class="Order_Report_Price"><span
                                        ...
                                        <td data-field="Price">
                                            ...
                                            <?php } else { ?>
                                            <div class="ew-table-header-btn ew-pointer Order_Report_Price"
                                        ...
                                        <td data-field="order_date">
                                            <div class="Order_Report_order_date"><span
                                        ...
                                        <td data-field="order_date">
                                            ...
                                            <?php } else { ?>
                                            <div class="ew-table-header-btn ew-pointer Order_Report_order_date"
                                        ...
                                        <td data-field="last_shipping_date">
                                            <div class="Order_Report_last_shipping_date"><span
                                        ...
                                        <td data-field="last_shipping_date">
                                            ...
                                            <?php } else { ?>
                                            <div class="ew-table-header-btn ew-pointer Order_Report_last_shipping_date"
...
?>
                                    <tr<?php echo $Page->rowAttributes(); ?>>
                                        ...
                                        <td data-field="bussiness_name"
                                            ...
                                            <span<?php echo $Page->bussiness_name->viewAttributes() ?>>
                                                <?php echo $Page->bussiness_name->getViewValue() ?></span>
                                        </td>
                                        <?php } ?>
                                        <?php if ($Page->address->Visible) { ?>
                                        <td data-field="address" <?php echo $Page->address->cellAttributes() ?>>
                                            <span<?php echo $Page->address->viewAttributes() ?>>
                                                <?php echo $Page->address->getViewValue() ?></span>
                                        </td>
                                        <?php } ?>
                                        <?php if ($Page->pname->Visible) { ?>
                                        ...
                                        <td data-field="Qty" <?php echo $Page->Qty->cellAttributes() ?>>
                                            <span<?php echo $Page->Qty->viewAttributes() ?>>
                                                <?php echo $Page->Qty->getViewValue() ?></span>
                                        </td>
                                        <?php } ?>
                                        <?php if ($Page->discount->Visible) { ?>
                                        <td data-field="discount" <?php echo $Page->discount->cellAttributes() ?>>
                                            <span<?php echo $Page->discount->viewAttributes() ?>>
                                                <?php echo $Page->discount->getViewValue() ?></span>
                                        </td>
                                        <?php } ?>
                                        <?php if ($Page->Price->Visible) { ?>
...
?>
                                    ...
                                    <tr<?php echo $Page->rowAttributes() ?>>
                                        <td
                                            colspan="<?php echo ($Page->GroupColumnCount + $Page->DetailColumnCount) ?>">
