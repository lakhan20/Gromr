...
$sideMenu->addMenuItem(31, "mi_Order_Report", $ReportLanguage->phrase("DetailSummaryReportMenuItemPrefix") . $ReportLanguage->menuPhrase("31", "MenuText") . $ReportLanguage->phrase("DetailSummaryReportMenuItemSuffix"), "Order_Reportsmry.php", -1, "", TRUE, FALSE, FALSE, "", "", FALSE);
