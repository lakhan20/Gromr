...
class Order_Report_summary extends Order_Report
{
	...
	public function loadRowValues($firstRow = FALSE)
	{
		...
		if (!$this->Recordset->EOF) {
			...
			$this->Values[1] = $this->Qty->CurrentValue;
			$this->Values[2] = $this->Price->CurrentValue;
			$this->Values[3] = $this->discount->CurrentValue;
			$this->Values[4] = $this->order_date->CurrentValue;
			$this->Values[5] = $this->last_shipping_date->CurrentValue;
			$this->Values[6] = $this->tax_amount->CurrentValue;
			$this->Values[7] = $this->net_amount->CurrentValue;
			$this->Values[8] = $this->pname->CurrentValue;
			$this->Values[9] = $this->brand->CurrentValue;
			$this->Values[10] = $this->description->CurrentValue;
			$this->Values[11] = $this->bussiness_name->CurrentValue;
		} else {
			$this->Qty->setDbValue("");
